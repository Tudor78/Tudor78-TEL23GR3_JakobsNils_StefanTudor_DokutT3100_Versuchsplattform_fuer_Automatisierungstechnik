...
\input{includes/ehrenwoertliche_erklaerung.tex}
...
\input{includes/auswahl_geeigneter_hardware.tex}
% \input{includes/stand_der_technik.tex}
% \input{includes/datengenerierung_edelstahldatensaetze.tex}
% \input{includes/optimierung_vektorberechnung.tex}
% \input{includes/qa_modell.tex}
\input{includes/reflexion_ausblick.tex}
