...
Rapid Control Prototyping bezeichnet einen Ansatz zur schnellen Entwicklung und Erprobung von Regelungsstrategien an Anwendungen oder Laboraufbauten. Charakteristisch ist, dass der Entwurf nicht primär durch eine manuelle Implementierung in textbasierten Programmiersprachen erfolgt, sondern durch die Modellierung als grafisches Blockdiagramm, das anschließend auf eine Zielplattform übertragen wird. Die grundlegende Zielrichtung von RCP besteht darin, auf eine manuelle Programmierung in textbasierten Sprachen zu verzichten und stattdessen ein grafisches Modell zu erstellen, aus dem die Entwicklungsplattform direkt programmiert wird. RCP unterstützt damit kurze Iterationszyklen, da Entwurf, Test und Parametrierung in engem Zusammenhang durchgeführt werden können \parencite{HoyosGutierrez2023RCPReview}.

Für die praktische Umsetzung wird RCP typischerweise als Kombination aus Zielhardware und Entwicklungssoftware verstanden. Die Zielhardware umfasst eine Recheneinheit mit Speicher sowie Ein und Ausgängen und kann je nach Anwendung als PC, Mikrocontroller, DSP oder programmierbare Logik realisiert sein. Die Software stellt eine grafische Modellierungsumgebung bereit, in der der Regelalgorithmus als Blockdiagramm beschrieben wird und aus der anschließend ausführbarer Code für die Zielplattform generiert wird \parencite{HoyosGutierrez2023RCPReview}. In vielen Anwendungen bildet Matlab in Verbindung mit Simulink die zentrale Entwicklungsumgebung, da der Reglerentwurf, die Simulation und die Implementierung über einen konsistenten Modellkern verbunden werden können \parencite{Werth2020LowCostRCP,Fang2009LowCostDSPRCP}. Die genaue Funktionsweise der Modellbasierten Entwicklung mit Matlab und Simulink wird in Abschnitt ~\ref{sec:Modellbasierte Entwicklung mit Matlab/Simulink} erläutert.
\newpage
